...
function change_display_by_icon(element, element_id, content_more, content_less, display_special) {
    ...
    element.style.background = 'url(\'' + ((element.className == "icon_less") ? 'https://web.archive.org/web/20171105085052/http://illiweb.com/fa/i/tabs_less.gif' : 'https://web.archive.org/web/20171105085052/http://illiweb.com/fa/i/tabs_more.gif') + '\') no-repeat';
...
function display_upload_servimg(button, account, id, f) {
    ...
    if (!document.getElementById('obj_servimg')) {
        container.innerHTML = '<p><iframe id="obj_servimg" src="https://web.archive.org/web/20171105085052/http://www.servimg.com/forum_upload.php?account=' + account + '&id=' + id + '&f=' + f + '" width="540" height="230" border="0" scrolling="no"></iframe></p>'
    }
...
function FM_widget_share() {
    ...
    gscript.src = 'https://web.archive.org/web/20171105085052/https://apis.google.com/js/plusone.js';
    if (gpluslang != '') {
    ...
    content += '<a href="https://web.archive.org/web/20171105085052/http://twitter.com/share" class="twitter-share-button" data-url="' + urlpage + '" data-count="vertical">Tweet</a><scr' + 'ipt type="text/javascript" src="https://web.archive.org/web/20171105085052/http://platform.twitter.com/widgets.js"></scr' + 'ipt>';
    content += '<iframe src="https://web.archive.org/web/20171105085052/http://www.facebook.com/plugins/like.php?' + fblang + 'href=' + encodeURIComponent(urlpage) + '&amp;send=false&amp;layout=box_count&amp;width=60&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=60" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:61px; height:61px;" allowTransparency="true"></iframe>';
